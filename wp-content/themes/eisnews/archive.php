            ...
            <div class="row <?php echo "category_page_" . $term->term_id; ?>">
                ...
                if ($q->have_posts()) {
                    ...
                    while ($q->have_posts()): $q->the_post();
                        ...
                        if ($post_count == 1) { ?>
                            <div class="my-2 col-lg-12 col-sm-12 col-12">

                                <div class="mb-5 category-page-first-news">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-2 category-page-first-news-heading">
                                                <a href="<?php the_permalink() ?>">
                                                    <h4><?php the_title() ?></h4>
                                                </a>
                                            </div>
                        ...
                        <?php } else { ?>
                            ...
                            <div class="my-2 col-lg-4 col-sm-6 col-6">
